    ...
    <main className="page-shell policy-page">
      <section className="subpage-hero">
        <div>
          ...
          <h1>How Aperture handles reader data.</h1>
          <p>
            This policy explains what limited information Aperture News stores, how third-party publisher content is
            handled, and how bookmarks work in the current product.
          </p>
        </div>
      ...
      <section className="policy-layout">
        <article className="policy-panel glass-panel">
          ...
          <p>
            Aperture News stores a minimal demo user record and bookmark associations so saved articles can be shown
          ...
          <p>
            Aperture News displays aggregated metadata, excerpts, and source images when available from publisher RSS
          ...
          <p>
            If you publish Aperture News publicly, add your real operator contact information here and update this
            policy as product functionality evolves.
          </p>
        </article>
      </section>
    </main>
